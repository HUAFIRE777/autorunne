...
0.6.19 是可公开演示、可教学、可早期交付验证的 Beta 版本。它已经跑通 GitHub Release、PyPI、真实项目 smoke test 和多 agent 入口说明。
...
发布包示例仍然保留：`autorunne-0.6.19-py3-none-any.whl`。发布整理命令：

```bash
autorunne release --version 0.6.19
```
