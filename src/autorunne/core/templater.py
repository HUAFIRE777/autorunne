...
7. End each slice with `autorunne checkpoint` or `autorunne finish`; agents/wrappers may omit `--summary` because Autorunne will generate one automatically.
"""
